...
@dtes.delete("/delete/{folio}/{branch_office_id}/{cashier_id}")
def delete(folio:int, branch_office_id:int, cashier_id:int, db: Session = Depends(get_db)):
    data = DteClass(db).delete(folio, branch_office_id, cashier_id)
