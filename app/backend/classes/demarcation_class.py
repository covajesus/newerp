...
class DemarcationClass:
    ...
    def get_all(self, page=0, items_per_page=10):
        try:
            ...
            query = self.db.query(
                ...
                DemarcationModel.made_parking_lines,
                DemarcationModel.made_road_signage,
            ...
            if page > 0:
                ...
                serialized_data = [{
                    ...
                    "made_parking_lines": demarcation.made_parking_lines,
    ...
    def get(self, id):
        try:
            data_query = self.db.query(
                                ...
                                DemarcationModel.made_pregnant,
                                DemarcationModel.made_wall,
                                DemarcationModel.file_made_parking_lines,
                                DemarcationModel.file_made_road_signage,
            ...
            if data_query:
                ...
                demarcation_data = {
                    ...
                    "made_parking_lines": data_query.made_parking_lines,
                    "made_road_signage": data_query.made_road_signage,
                    ...
                    "file_made_parking_lines": data_query.file_made_parking_lines,
                    "file_made_road_signage": data_query.file_made_road_signage,
    ...
    def store(self, form_data, remote_path1, remote_path2, remote_path3, remote_path4, remote_path5, remote_path6):
        ...
        demarcation.made_parking_lines = form_data.made_parking_lines
        ...
        demarcation.file_made_parking_lines = remote_path1
        demarcation.file_made_road_signage = remote_path2
