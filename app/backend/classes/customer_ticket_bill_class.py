        ...
        try:
            ...
            if page > 0:
                ...
                serialized_data = [{
                    ...
                    "added_date": datetime.strptime(dte.added_date, '%Y-%m-%d').strftime('%Y-%m-%d') if isinstance(dte.added_date, str) else dte.added_date.strftime('%Y-%m-%d') if dte.added_date else None,
