...
class TransbankStatementClass:
    ...
    _COLUMN_ALIASES = {
        ...
        "auth_code": (
            ...
            "Codigo de autorizacion de venta",
            "Código de autorizacion de venta",
            "Codigo de autorización de venta",
            "Código de autorización de venta",
            "Numero unico",
            "Número unico",
            "Número único",
            "ID de la transaccion (TID)",
            "ID de la transacción (TID)",
        ),
        "cuotas": (
            "N° Cuotas",
            "N Cuotas",
