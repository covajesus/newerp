...
class ReceivedInboxModel(Base):
    ...
    document_status = Column(String(64))
    sii_status = Column(String(64))
    acknowledgment_status = Column(String(64))
...
class CustomerDteItemModel(Base):
    ...
    dsc_item = Column(String(500), nullable=True)
    item_code = Column(String(64), nullable=True)
    item_name = Column(String(255), nullable=True)
    unit_measure = Column(String(32), nullable=True)
...
class SettingModel(Base):
    ...
    # SII tax password for BTE (third-party service receipts / honorarios)
    sii_login_rut = Column(String(32))
    sii_tax_password = Column(Text)
    added_date = Column(DateTime())
    updated_date = Column(DateTime())
